...
useEffect(() => {
  // Retrieve flood severity from local storage if it exists
  const savedFloodSeverity = localStorage.getItem('floodSeverity');
...
useEffect(() => {
  ...
  if (floodSeverity !== null) {
    localStorage.setItem('floodSeverity', floodSeverity);
  }
}, [floodSeverity]);
